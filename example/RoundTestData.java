...
public class RoundTestData
{
    ...
    static final float testRoundMidPointN = 0.5f;
    static final float testRoundMidPointExpectedResult = 1f;

    static final float testRoundMidPointUnderN = 0.4f;
    static final float testRoundMidPointUnderExpectedResult = 0f;

    static final float testRoundMidPointOverN = 0.6f;
    static final float testRoundMidPointOverExpectedResult = 1f;
